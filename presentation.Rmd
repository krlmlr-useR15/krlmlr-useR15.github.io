...
1. Fast weighted random sampling without replacement
    - Truncate-replicate-sample in spatial microsimulation
2. Convert Gower distance to Manhattan metric
    - Similarity-based statistical matching
3. Avoid path enumeration
    - Management of package dependencies
4. Carefully read implementation notes
    - Survey calibration
